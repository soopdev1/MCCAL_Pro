                                                        ...
                                                        <div class="kt-section kt-section--space-md">
                                                            <div class="form-group form-group-sm row">
                                                                <div class="col-lg-10">
                                                                    ...
                                                                    <%
                                                                        String nosel = "selected";
                                                                        String selp1 = "";
                                                                        String selp2 = "";
                                                                        if (a.getTarget() == null) {

                                                                        } else if (a.getTarget().equals("P1")) {
                                                                            nosel = "";
                                                                            selp1 = "selected";
                                                                        } else if (a.getTarget().equals("P2")) {
                                                                            nosel = "";
                                                                            selp2 = "selected";
                                                                        }
                                                                    %>
                                                                        ...
                                                                        <div class="form-group col-xl-3 col-lg-6">
                                                                            ...
                                                                            <div class="dropdown bootstrap-select form-control kt-" id="target_div" style="padding: 0;">
                                                                                <select class="form-control kt-select2-general obbligatory" 
                                                                                    ...
                                                                                    <option value="-" <%=nosel%> >Seleziona target</option>
                                                                                    <option value="P1" <%=selp1%> >Professionista</option>
                                                                                    <option value="P2" <%=selp2%>>Non NEET</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                    </div>    
